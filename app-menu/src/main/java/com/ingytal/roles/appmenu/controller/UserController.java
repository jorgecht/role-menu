...
public class UserController {
	...
	@PostMapping
	public ResponseEntity<UserEntity> createProduct(@RequestBody UserEntity user){
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<UserEntity> createProduct(@PathVariable Long id, @RequestBody UserEntity user){
		user.setId(id);
	...
	public ResponseEntity<UserEntity> deleteProduct(@PathVariable Long id){
